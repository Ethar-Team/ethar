...
cards.addEventListener('click',renderform)
    ...
    function renderform (event){
        ...
        formSection.setAttribute("id","left-sec")
        ...
        if (category==="maintenance"){
            ...
            paragraph1.textContent="Paragraph1"

            let maintenanceForm=document.createElement("form")
            formSection.appendChild(maintenanceForm)
            let fieldset=document.createElement("fieldset")
            maintenanceForm.appendChild(fieldset)
        ...
        if (category==="teaching"){
            ...
            let paragraph1=document.createElement("p")
            formSection.appendChild(paragraph1)
            paragraph1.textContent="Paragraph2"

            let teachingForm=document.createElement("form")
            teachingForm.appendChild(teachingForm)
            let fieldset=document.createElement("fieldset")
            teachingForm.appendChild(fieldset)
